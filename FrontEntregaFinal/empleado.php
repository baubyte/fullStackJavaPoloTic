        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                        <a href="#" class="btn btn-lg btn-success"><i class="material-icons">account_box</i> Nuevo Empleado</a>
                            <div class="card">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="td-actions">
                                                        <button type="button" rel="tooltip" title="Editar Empleado" class="btn btn-white btn-link btn-sm">
                                                            <i class="material-icons">edit</i>
                                                        </button>
                                                        <button type="button" rel="tooltip" title="Borrar Empleado" class="btn btn-white btn-link btn-sm">
