        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="#" class="btn btn-lg btn-success"><i class="material-icons">fingerprint</i>Nuevo Usuario</a>
                            <div class="card">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="td-actions">
                                                        <button type="button" rel="tooltip" title="Editar Usuario" class="btn btn-white btn-link btn-sm">
                                                            <i class="material-icons">edit</i>
                                                        </button>
                                                        <button type="button" rel="tooltip" title="Borrar Usuario" class="btn btn-white btn-link btn-sm">
